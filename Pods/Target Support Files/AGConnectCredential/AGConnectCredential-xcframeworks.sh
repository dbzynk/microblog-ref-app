...
install_xcframework "${PODS_ROOT}/AGConnectCredential/AGConnectCredential.xcframework" "AGConnectCredential" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
