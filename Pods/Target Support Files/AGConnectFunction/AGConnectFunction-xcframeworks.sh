...
install_xcframework "${PODS_ROOT}/AGConnectFunction/AGConnectFunction.xcframework" "AGConnectFunction" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
